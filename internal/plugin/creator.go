...
func (c *Creator) New(config *pangu.Config, logger log.Logger) (scheduler *schedule.Scheduler, err error) {
	wrapper := new(Wrapper)
...
func (c *Creator) new(config *Config, logger log.Logger) (scheduler *schedule.Scheduler, err error) {
